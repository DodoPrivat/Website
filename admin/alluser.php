...
while($row=mysqli_fetch_assoc($sql)){
  ...
  <tr>
    ...
    <td><a href="edit.php?uid=<?php echo $row['user_id'];?>" class="btn btn-danger"> Delete</a></td>
   <td> <a href="edit.php?uid=<?php echo $row['user_id'];?>" class="btn btn-success"> Edit</a></td>
    <td> <a href="enabled.php?uid=<?php echo $row['user_id'];?>" class="btn btn-primary"> Enable</a></td>
  </tr>
