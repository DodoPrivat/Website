    ...
    <div class="sidebar-collapse">
      <ul class="nav" id="main-menu">
        ...
        <li><a href="addsubcategory.php"> Add New Sub Category</a></li>
         ...
         <li><a href="#"><i class="fa fa-cubes fa-3x"></i> Products
        <span class="fa arrow"></span></a>
        <ul class=" nav nav-second-level">
        <li><a href="addprdouct.php"> Add New Product</a></li>
         ...
         <li><a href="#"><i class="fa fa-building fa-3x"></i> Vendors
        <span class="fa arrow"></span></a>
        <ul class=" nav nav-second-level">
        <li><a href="addvendor.php"> Add New Vendor</a></li>
         <li><a href="allvendor.php"> Manage All Vendors</a></li>
          <li><a href="searchvendor.php"> Search Vendor</a></li>
         </ul>
         </li>
         <li><a href="#"><i class="fa fa-users fa-3x"></i> Users
        <span class="fa arrow"></span></a>
        <ul class=" nav nav-second-level">
        <li><a href="adduser.php"> New User</a></li>
         ...
         <li><a href="#"><i class="fa fa-comments fa-3x"></i> Comments
        <span class="fa arrow"></span></a>
        <ul class=" nav nav-second-level">
        <li><a href="comment.php"> New Comments</a></li>
         <li><a href="allcomments.php"> Manage All Comments</a></li>
          ...
          <li><a href="#"><i class="fa fa-suitcase fa-3x"></i> Content Managrment
        <span class="fa arrow"></span></a>
        <ul class=" nav nav-second-level">
        <li><a href="logo.php"> Add Logo/Image</a></li>
         <li><a href="pages.php"> Add Pages</a></li>
                  <li><a href="headings.php"> Add Heading</a></li>
                           <li><a href="content.php"> Add Content</a></li>
                       </ul>      
                           <li><a href="#"><i class="fa fa-line-chart fa-3x"></i>Statistics        <span class="fa arrow"></span></a>
        <ul class=" nav nav-second-level">
