...
if(isset($_SESSION['name'])) { 
   header("location: dashoboard.html");
   exit; 
}
...
<h1 class=headingtext> Registration For Vendor</h1>
...
<input type="username" required autocomplete="off" name="vname" id="vname" onBlur="checkAvailability()" class="text"  />
...
<input type="Phone" required autocomplete="off" name="phone" class="text" />
...
<label>
Bakery Name<span class="req">*</span>
</label>
<input type="bkmname" required autocomplete="off" name="bkname" id="bkname" class="text"  />
...
<div class="btn btn-primary btn-sm">
            <span>Upload Your Bakery Logo </span>
...
<input type="text"required autocomplete="off" name="addr" class="text" />
